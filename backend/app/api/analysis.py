...
def google_ads_analysis(
    ...
    try:
        ...
        logger.exception(
            "Analysis google-ads failed | org=%s client_id=%s days=%s start_date=%s end_date=%s error=%s",
            org, client_id, days, start_date, end_date, str(e)[:300],
        )
        raise
...
def google_analytics_analysis(
    ...
    try:
        ...
        logger.exception(
            "Analysis google-analytics failed | org=%s client_id=%s days=%s start_date=%s end_date=%s error=%s",
            org, client_id, days, start_date, end_date, str(e)[:300],
        )
        raise
