...
# So chat() does not return "Datasets are not configured" for org1
_ORG_BQ_CTX = {"projects": [{"bq_project": "proj", "datasets": [{"bq_dataset": "marts", "bq_location": None, "type": "marts"}]}]}
